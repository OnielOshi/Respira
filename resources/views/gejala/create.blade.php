        ...
        <div class="card-body">
            ...
            <form action="{{ route('gejala.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_gejala" id="kode_gejala" class="form-control" value="{{ old('kode_gejala') }}">
                </div>
                <div class="mb-3">
                    <label for="nama_gejala" class="form-label">{{ __('Gejala') }}</label>
                    <input type="text" name="nama_gejala" id="nama_gejala" class="form-control" value="{{ old('nama_gejala') }}">
                </div>
